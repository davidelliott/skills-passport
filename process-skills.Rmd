...
for(student in students) {
  ...
  cat("<hr>\nHello ",s_name,"(ID ",student,"; Badge ",s_badge,")\n\n","
...
")
  ...
  if(length(s_badge)<1) {
   cat("*** We do not have a record of your badge number. This means your skills report is based only on manual records and not including any scans you may have had. Please contact your personal tutor and inform them of your badge number. ") 
  }
  # print student info
